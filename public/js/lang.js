const translations = {
  ES: {
    ...
    noLessonsFound: "No se ha encontrado la lección seleccionada.",
  ...
  EN: {
    ...
    noLessonsFound: "Selected lesson not found.",
  ...
  EU: {
    ...
    errorLogin: "Erabiltzaile-izena edo pasahitza okerra da",
    error: "Errorea",
    ...
    noLessonsFound: "Ez da hautatutako ikasgaia aurkitu.",
